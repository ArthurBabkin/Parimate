...
class SpeechValidator:
    """
    Класс для проверки произношения слов в аудиофайлах
    """
    ...
    def __init__(self):
        ...
        """
        self.speech_model = YandexSpeechKit()
        self.nlp_model = NLP_analysis()
    
    def validate_pronunciation(self, audio_file_path: str, target_word: str) -> bool:
        """
        ...
        try:
            ...
            transcription_result = self.speech_model.process_audio(audio_file_path)
            ...
            for t in transcriptions:
                if self.nlp_model.process_corpus(t['text'], target_word):
...
if __name__ == "__main__":
    ...
    result = validator.validate_pronunciation(audio_path, word)
